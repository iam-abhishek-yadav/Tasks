...
//   const mode: string = Array.isArray(params?.["mode"]) ? params["mode"][0] : params?.["mode"] || "signin"
//   const router = useRouter()

//   const { formData, errors, isSubmitting, handleChange, setSubmitting, validateForm, resetErrors, resetFormData } =
//     useAuthStore()
...
//           <CardTitle className="text-center text-2xl font-bold">{isSignup ? "Create an Account" : "Sign In"}</CardTitle>
//         </CardHeader>
...
//               />
//             )}
//             {errors && <div className="text-red-500 text-center text-xs">{errors}</div>}
//           </CardContent>
